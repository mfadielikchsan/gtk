...
<style>
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>Operator</li>
                <li class="active">Input Stock Produk</li>
            </ol>
        </section>
                        ...
                        <div class="col-md-12" style="margin-bottom:25px;">
                            <div class="box-header" style="margin-bottom:25px;">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Input Stock Barang</h3>
                                </div>
                                <br>
                                <button data-toggle="modal" data-target="#modalTambahStock" type="button" class="btn btn-primary"><i class="fa fa-plus"></i> Input Stock</button>
                                @include('portalgtk.modal.input_stock')    
                            </div>
    ...
    <script>
        ...
        function getTotalStock(id) {
            let awal = $(`#awal${id}`).val() || 0;
            let masuk = $(`#masuk${id}`).val() || 0;
            let keluar = $(`#keluar${id}`).val() || 0;
            let intawal = parseInt(awal);
            let intmasuk = parseInt(masuk);
            let intkeluar = parseInt(keluar);
            let hasil = intawal + intmasuk - intkeluar;
            $(`#total${id}`).val(hasil);
        }
